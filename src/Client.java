...
public class Client implements ActionListener {
    ...
    Client() {
        ...
        ImageIcon icon = new ImageIcon("D:\\Java practice\\Chatting Application\\src\\icons\\OIG2.jpeg");
    ...
    public static void main(String[] args) {
        new Client();
        try {
            //port identify specific process on the computer network
